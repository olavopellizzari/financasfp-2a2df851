...
export function Dashboard() {
  ...
  return (
    <div className="space-y-6 animate-fade-in w-full max-w-full overflow-x-hidden pb-10">
      ...
      <Accordion type="multiple" defaultValue={["financial-balance", "smart-control", "transaction-flow", "transaction-summary", "planning-center", "card-expenses", "top-expenses", "latest-activities"]} className="w-full space-y-4">
        {/* Balanço Financeiro */}
        ...
        <AccordionItem value="transaction-summary" className="border-none shadow-md rounded-xl overflow-hidden">
          <AccordionTrigger className="px-6 py-4 hover:no-underline bg-card hover:bg-muted/50">
            <div className="flex items-center gap-3 text-left">
              <div className="p-2 rounded-lg bg-primary/10 text-primary">
              ...
              <div>
                <CardTitle className="text-lg">Resumo de Lançamentos</CardTitle>
                <CardDescription>Visão consolidada dos seus gastos e receitas.</CardDescription>
              </div>
            </div>
          </AccordionTrigger>
          <AccordionContent className="p-6 bg-card">
        ...
        <AccordionItem value="planning-center" className="border-none shadow-md rounded-xl overflow-hidden">
          <AccordionTrigger className="px-6 py-4 hover:no-underline bg-card hover:bg-muted/50">
            <div className="flex items-center gap-3 text-left">
              <div className="p-2 rounded-lg bg-primary/10 text-primary">
              ...
              <div>
                <CardTitle className="text-lg">Centro de Planejamento</CardTitle>
                <CardDescription>Orçamento, metas e dívidas em um só lugar.</CardDescription>
              </div>
            </div>
          </AccordionTrigger>
          <AccordionContent className="p-6 bg-card">
        ...
        {/* Gastos por Cartão */}
        <AccordionItem value="card-expenses" className="border-none shadow-md rounded-xl overflow-hidden">
          <AccordionTrigger className="px-6 py-4 hover:no-underline bg-card hover:bg-muted/50">
            <div className="flex items-center gap-3 text-left">
              <div className="p-2 rounded-lg bg-primary/10 text-primary">
              ...
              <div>
                <CardTitle className="text-lg">Gastos por Cartão</CardTitle>
                <CardDescription>Visão detalhada dos gastos por cartão de crédito.</CardDescription>
              </div>
            </div>
          </AccordionTrigger>
          <AccordionContent className="p-6 bg-card">
        ...
        {/* Top 10 Despesas */}
        <AccordionItem value="top-expenses" className="border-none shadow-md rounded-xl overflow-hidden">
          <AccordionTrigger className="px-6 py-4 hover:no-underline bg-card hover:bg-muted/50">
            <div className="flex items-center gap-3 text-left">
              <div className="p-2 rounded-lg bg-primary/10 text-primary">
              ...
              <div>
                <CardTitle className="text-lg">Top 10 Despesas</CardTitle>
                <CardDescription>Suas categorias de gastos mais relevantes.</CardDescription>
              </div>
            </div>
          </AccordionTrigger>
          <AccordionContent className="p-6 bg-card">
        ...
        {/* Últimas Atividades */}
        <AccordionItem value="latest-activities" className="border-none shadow-md rounded-xl overflow-hidden">
          <AccordionTrigger className="px-6 py-4 hover:no-underline bg-card hover:bg-muted/50">
            <div className="flex items-center gap-3 text-left">
              <div className="p-2 rounded-lg bg-primary/10 text-primary">
                <History className="h-5 w-5" />
