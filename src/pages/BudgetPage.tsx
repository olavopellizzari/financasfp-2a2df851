...
export function BudgetPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {selectedUserId === 'all' ? (
        <Card className="border-dashed"><CardContent className="py-12 text-center"><Target className="h-12 w-12 mx-auto text-muted-foreground mb-4" /><h3 className="text-lg font-medium mb-2">Selecione um usuário para gerenciar o orçamento</h3></CardContent></Card>
      ) : !budget ? (
